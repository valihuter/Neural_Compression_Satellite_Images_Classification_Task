#!/usr/bin/env python3
"""
JPEG2000 EuroSAT Test Set Evaluation with Per-Class Results
For cross-over analysis between codecs.
"""
import sys
import json
...
COMPRESSED_BASE = PROJECT_ROOT / "data" / "EUROSAT" / "comp" / "jpeg2000_compressed"
...
OUTPUT_FILE = PROJECT_ROOT / "results" / "json" / "eurosat_jpeg2000_class_evaluation.json"
...
for model_name, model, transform in [
    ...
    for q in QUALITY_LEVELS:
        ...
        compressed_dir = COMPRESSED_BASE / f"jpeg2000_{q}"
        ...
        for class_name in CLASSES:
            ...
            for img_path in class_dir.glob("*.jp2"):
                filename = img_path.name
                basename = filename.replace('.jp2', '')
